<!DOCTYPE html>
<html lang="en">
   <!-- Mirrored from themesbrand.com/veltrix/layouts/vertical/pages-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 Mar 2019 14:19:29 GMT -->
   <head>
      <meta charset="utf-8">
   ...
   <body>
      ...
      <div class="wrapper-page">
         <div class="card overflow-hidden account-card mx-3">
            <div class="bg-primary p-4 text-white text-center position-relative">
               ...
               <a href="index.html" class="logo logo-admin"><img src="{{asset('public/admin/assets')}}/images/logo-sm.png" height="24" alt="logo"></a>
            </div>
      ...
      <!-- end wrapper-page --><!-- jQuery  --><script src="{{asset('public/admin/assets')}}/js/jquery.min.js"></script><script src="{{asset('public/admin/assets')}}/js/bootstrap.bundle.min.js"></script><script src="{{asset('public/admin/assets')}}/js/metisMenu.min.js"></script><script src="{{asset('public/admin/assets')}}/js/jquery.slimscroll.js"></script><script src="{{asset('public/admin/assets')}}/js/waves.min.js"></script><!-- App js --><script src="{{asset('public/admin/assets')}}/js/app.js"></script>
   </body>
   <!-- Mirrored from themesbrand.com/veltrix/layouts/vertical/pages-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 Mar 2019 14:19:29 GMT -->
</html>