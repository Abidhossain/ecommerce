         ...
         <div class="modal-body">
            <form id="insert_form">
               ...
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="category_description" id="category_description" placeholder="Category Desdription">
               </div>
               <div class="form-group">
...
<div class="row">
   ...
   <div class="card">
      <div class="card-body"> 
             <h4>Category List <button type="button" class="btn btn-sm btn-primary float-right" data-toggle="modal" data-target="#exampleModal">Category Add</button> </h4>      
...
<script type="text/javascript">
   ...
   /*====================Show data by ajax=======================*/
    ...
    function readData(){ 
       ...
       $.get("{{url('category-read')}}", function(data){ 
               $('#category_info').empty().html(data); 
       }); 
    }
   ...
   /*====================Edit Data By Ajax=======================*/ 
         ...
         $('#category_info').delegate('#edit', 'click', function(){ 
           ...
           $.get('{{url('category-edit')}}/' + id, function(data) { 
               ...
               $('#update_form').find('#category_name').val(data.category_name); 
